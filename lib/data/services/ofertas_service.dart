...
/// `/user/queue/ofertas`, por la que el backend empuja `PEDIDO_NUEVO` en tiempo
/// real (redundante al push FCM y al sondeo REST).
///
...
class OfertasService {
  ...
  /// Stream de ids de pedido ofertados. Broadcast: admite reengancharse.
  Stream<int> connect() {
